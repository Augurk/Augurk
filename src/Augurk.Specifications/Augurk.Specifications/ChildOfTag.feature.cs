...
To combat the ever growing set of feature files becoming completely unmanageable, Augurk offers the option to nest feature files in a hierarchical way.", ProgrammingLanguage.CSharp, new string[] {
        ...
        public virtual void TestInitialize()
        {
            if (((TechTalk.SpecFlow.FeatureContext.Current != null) 
                        && (TechTalk.SpecFlow.FeatureContext.Current.FeatureInfo.Title != "Nesting Features")))
            {
                Augurk.Specifications.NestingFeaturesFeature.FeatureSetup(null);
            }
        }
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("This feature is a child of the Server-side Tags feature", ((string[])(null)));
#line 6
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Opening a nested feature", ((string[])(null)));
#line 12
this.ScenarioSetup(scenarioInfo);
#line 14
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("A feature has been nested under a feature that does not exist", ((string[])(null)));
#line 18
this.ScenarioSetup(scenarioInfo);
#line 20
